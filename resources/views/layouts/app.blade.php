...
<body class="bg-gray-100">
    <header class="p-5 border-b bg-gray-500 shadow-xl">
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="flex gap-2 items-center">
                    <a class="flex items-center gap-2 bg-red-200  p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer"
