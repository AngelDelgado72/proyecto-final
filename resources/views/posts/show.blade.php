        ...
        <div class="md:w-1/2 p-5">
            <div class="shadow bg-white p-5 mb-5">
                ...
                <p class="font-bold">
                    ...
                    {{ $post->user->username }} <span class="font-normal"> {{ $post->descripcion }} </span>
                </p>
                        ...
                        @foreach ($post->comentario as $comentarios)
                            <div class="p-5 border-gray-300 border-b">
                                <div style="display: flex;justify-content: space-between;">
                                    <a href="{{ route('posts.index', $comentarios->user) }} ">
                                    <span class="font-bold"> {{ $comentarios->user->username }} </span> <span class="text-normal"> {{ $comentarios->comentario }} </span>
                                    </a>
